...
export interface ApiAlbumAlbum extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    creators: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiFeaturedPhotoFeaturedPhoto extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::featured-photo.featured-photo'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    albums: Schema.Attribute.Relation<'manyToOne', 'api::album.album'>;
